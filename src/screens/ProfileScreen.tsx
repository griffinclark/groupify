...
export const ProfileScreen = ({ navigation }: Props) => {
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      >
        <Text style={{ fontSize: 18, fontWeight: '400' }}>Notifications</Text>
      ...
      >
        ...
        >
          ...
          <Text style={{ fontSize: 18, fontWeight: '400' }}>Edit Friends List</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          ...
          <Text style={{ fontSize: 18, fontWeight: '400' }}>Submit Bug Report</Text>
        </TouchableOpacity>
      </View>
      <View
        style={{
      ...
      >
        ...
        >
          ...
          <Text style={{ fontSize: 18, fontWeight: '400' }}>Reset Password</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={async () => {
            try {

import { DataStore, API, graphqlOperation, Predicates, SortDirection } from 'aws-amplify';
...
import { GREY_1, GREY_10 } from '../res/styles/Colors';
                    ...
                    {notifications.length > 0 ? (
                        notifications.map((notification: any) => (
                            <View style={styles.notificationItem}>
                                ...
                                <AppText style={styles.notificationTime}>{returnCreatedTime(notification.notification.createdAt)}</AppText>
                            </View>
                        ))
                    ) : (
                            <View style={{ flex: 1, marginTop: 111, alignItems: 'center'}}>
                                <PartyIcon />
                                <AppText style={{ marginTop: 20, fontSize: 20, lineHeight: 29, fontFamily: JOST[400], textAlign: 'center'}}>
                                    Nothing to see here! {'\n'}

...
const PageOne: React.FC = () => {
  return (
    <View>
      ...
      <AppText style={styles.modalText}>Restaurants , Bakeries, Diners, Takeout, Pizzerias, Fast Food, Bars</AppText>
...
export const ActivityModal: React.FC<Props> = ({ modal, setModal, page }: Props) => {
